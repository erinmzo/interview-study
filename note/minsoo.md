...
> E2E 테스트는 어플리케이션의 사용자 경험을 처음부터 끝까지 시뮬레이션 하여 테스트 하는 방법입니다. 다양한 시나리오를 테스트합니다. 보통은 Cypress, PlayWright 과 같은 도구를 사용하여 작성합니다. 이러한 테스트는 사용자에게 직접적인 여얗ㅇ을 미치는 오류를 조기에 발견할 수 있습니다.
